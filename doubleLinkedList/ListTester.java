 ...
 * get you started.
 * 
 * @author mvail, mhthomas, awinters, and Jacob Smith
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		testTwoElementList(A_addElementB_AB, "A_addElementB_AB", LIST_AB, STRING_AB);
		...
		testThreeElementList(AB_addAfterB_C_ABC, "AB_addAfterB_C_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(AB_addElementC_ABC, "AB_addElementC_ABC", LIST_ABC, STRING_ABC);
		...
		testTwoElementList(ABC_removeElementA_BC, "ABC_removeElementA_BC", LIST_BC, STRING_BC);
		testTwoElementList(ABC_removeElementB_AC, "ABC_removeElementB_AC", LIST_AC, STRING_AC);
		...
		testTwoElementList(A_ListIterAddBwithNewIter_BA, "A_ListIterAddBwithNewIter_BA", LIST_BA, STRING_BA);
		...
		testThreeElementList(AB_ListIterAddCwithNewIter_CAB, "AB_ListIterAddCwithNewIter_CAB", LIST_CAB, STRING_CAB);
	...
	/** Scenario: empty list -> addElement(A) -> [A] 
	 * @return [A] after addElement(A)
	 */
	private IndexedUnsortedList<Integer> emptyList_addElementA_A() {
		IndexedUnsortedList<Integer> list = newList(); 
		list.add(ELEMENT_A);
		return list;
	}
	private Scenario<Integer> emptyList_addElementA_A = () -> emptyList_addElementA_A();
	...
	/** Scenario [A] -> addElement(B) -> [A,B]
	 * @return [A,B] after addElement(B)
	 */
	private IndexedUnsortedList<Integer> A_addElementB_AB() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
		list.add(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_addElementB_AB = () -> A_addElementB_AB();
	...
	/** Scenario: [A] -> listIterator().previous(); set(B) -> [B]
 	* @return [B] after listIterator().previous(); set(B)
 	*/
	...
	/** Scenario: [A,B] --> listerIterator().add(C) -> [C,A,B]
	...
	/** Scenario: [A,B] --> listerIterator().next(); next(); add(C) -> [A,C,B]
	 * @return [A,C,B] after listIterator().next(); next(); add(C)
	 */
	...
	/** Scenario: [A,B] --> listerIterator().next(); next(); next(); add(C) -> [A,B,C]
	 * @return [A,B,C] after listIterator().next(); next(); next(); add(C)
	 */
	...
	/** Scenario: [A,B] -> listIterator().remove() -> [B]
 	* @return [B] after listIterator().remove()
 	*/
	...
	private Scenario<Integer> AB_ListIterRemove_B = () -> AB_ListIterRemove_B();

	/** Scenario: [A,B] -> listIterator().next(); next(); remove() -> [A]
 	* @return [A] after listIterator().next(); next(); remove()
 	*/
	...
	/** Scenario: [A,B] -> listIterator().next(); set(C) -> [C,B]
 	* @return [C,B] after listIterator().next(); set(C)
 	*/
	...
	/** Scenario: [A,B] -> listIterator().next(); next(); set(C) -> [A,C]
 	* @return [A,C] after listIterator().next(); next(); set(C)
 	*/
	...
	/** Scenario: [A,B] -> listIterator().next(); previous(); set(C) -> [C,B]
 	* @return [C,B] after listIterator().next(); previous(); set(C)
 	*/
	...
	Scenario<Integer> AB_ListIterSetCAfterPrevious_CB = () -> AB_ListIterSetCAfterPrevious_CB ();

	/** Scenario: [A,B] -> listIterator().next(); next(); previous(); set(C) -> [A,C]
 	* @return [A,C] after listIterator().next(); next(); previous(); set(C)
 	*/
	private IndexedUnsortedList<Integer> AB_ListIterSetCAfterPrevious_B_AC () {
		IndexedUnsortedList<Integer> list = ABC_IterRemoveC_AB();
	...
	Scenario<Integer> AB_ListIterSetCAfterPrevious_B_AC = () -> AB_ListIterSetCAfterPrevious_B_AC ();
 	...
 	*/
	private IndexedUnsortedList<Integer> AB_addAfterA_C_ACB() {
	IndexedUnsortedList<Integer> list = A_addToRearB_AB();   
	list.addAfter(ELEMENT_C, ELEMENT_A);                    
	return list;
	}
	private Scenario<Integer> AB_addAfterA_C_ACB = () -> AB_addAfterA_C_ACB();

	/** Scenario: [A,B] -> addAfter(C,B) -> [A,B,C]
 	* @return [A,B,C] after addAfter(C,B)
 	*/
	private IndexedUnsortedList<Integer> AB_addAfterB_C_ABC() {
	IndexedUnsortedList<Integer> list = A_addToRearB_AB();   
	list.addAfter(ELEMENT_C, ELEMENT_B);
	return list;
	}
	private Scenario<Integer> AB_addAfterB_C_ABC = () -> AB_addAfterB_C_ABC();

	/** Scenario: [A,B] -> addElement(C) -> [A,B,C]
 	* @return [A,B,C] after addElement(C)
 	*/
	private IndexedUnsortedList<Integer> AB_addElementC_ABC() {
	IndexedUnsortedList<Integer> list = A_addToRearB_AB();   
	list.add(ELEMENT_C);                                     
	return list;
	}
	private Scenario<Integer> AB_addElementC_ABC = () -> AB_addElementC_ABC();
 	...
 	*/
	private IndexedUnsortedList<Integer> ABC_removeElementA_BC() {
	IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
	list.remove(ELEMENT_A);                                    
	return list;
	}
	private Scenario<Integer> ABC_removeElementA_BC = () -> ABC_removeElementA_BC();

	/** Scenario: [A,B,C] -> remove(B) -> [A,C]
 	* @return [A,C] after remove(B)
 	*/
	private IndexedUnsortedList<Integer> ABC_removeElementB_AC() {
	IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
	list.remove(ELEMENT_B);
	return list;
	}
	private Scenario<Integer> ABC_removeElementB_AC = () -> ABC_removeElementB_AC();
	...
	*/
	...
	/** Scenario: [A,B,C] -> listIterator().next(); set(D) -> [D,B,C]
 	* @return [D,B,C] after listIterator().next(); set(D)
 	*/
	...
	/** Scenario: [A,B,C] -> listIterator().next(); next(); set(D) -> [A,D,C]
 	* @return [A,D,C] after listIterator().next(); next(); set(D)
 	*/
	...
	/** Scenario: [A,B,C] -> listIterator().next(); next(); next(); set(D) -> [A,B,D]
 	* @return [A,B,D] after listIterator().next(); next(); next(); set(D)
 	*/
	...
	/** Scenario: [A] -> iterator() -> remove(A) -> [ ]
 	* @return [ ] after iterator remove(A)
	*/
	...
	/** Scenario: [A,B] -> iterator() -> remove(A) -> [B]
 	* @return [B] after iterator remove(A)
 	*/
	...
	/** Scenario: [A,B] -> iterator() -> remove(B) -> [A]
 	* @return [A] after iterator remove(B)
 	*/
	...
	/** Scenario: [A,B,C] -> iterator() -> remove(A) -> [B,C]
 	* @return [B,C] after iterator remove(A)
 	*/
	...
	/** Scenario: [A,B,C] -> iterator() -> remove(B) -> [A,C]
 	* @return [A,C] after iterator remove(B)
 	*/
	...
	/** Scenario: [A,B,C] -> iterator() -> remove(C) -> [A,B]
 	* @return [A,B] after iterator remove(C)
 	*/
	...
	*/
	private IndexedUnsortedList<Integer> A_ListIterAddBwithNewIter_BA() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> iter = list.listIterator();
		iter.add(ELEMENT_B);
		return list;
	}
	private Scenario<Integer> A_ListIterAddBwithNewIter_BA = () -> A_ListIterAddBwithNewIter_BA();

	/** Scenario: [A] -> next(); add(B) -> [A,B]
	* @return [A,B] after next(); add(B)
	*/
	...
	/** Scenario: [A] -> previous(); add(B) -> [B,A]
	* @return [B,A] after previous(); add(B)
	*/
	...
	/** Scenario: [A,B] -> listIterator().add(C) -> [C,A,B]
	 * @return [C,A,B] after listIterator().add(C)
	*/
	private IndexedUnsortedList<Integer> AB_ListIterAddCwithNewIter_CAB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> iter = list.listIterator();
		iter.add(ELEMENT_C);
		return list;
	}
	private Scenario<Integer> AB_ListIterAddCwithNewIter_CAB = () -> AB_ListIterAddCwithNewIter_CAB();

	/** Scenario: [A,B] -> next(); add(C) -> [A,C,B]
	 * @return [A,C,B] after next(); add(C)
	*/
	...
	/** Scenario: [A,B] -> next(); next(); add(C) -> [A,B,C]
	 * @return [A,B,C] after next(); next(); add(C)
	*/
	...
	/** Scenario: [A,B] -> previous(); add(C) -> [C,A,B]
	 * @return [C,A,B] after previous(); add(C)
	*/
	...
	/** Scenario: [A] -> next(); set(B) -> [B]
	 * @return [B] after next(); set(B)
	*/
	...
	/** Scenario: [A] -> previous(); set(B) -> [B]
	 * @return [B] after previous(); set(B)
	*/
	private IndexedUnsortedList<Integer> A_ListIterSetBafterPrevious_B() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		ListIterator<Integer> iter = list.listIterator(1);
	...
	/** Scenario: [A,B] -> next(); set(C) -> [C,B]
	 * @return [C,B] after next(); set(C)
	*/
	...
	/** Scenario: [A,B] -> next(); next(); set(C) -> [A,C]
	 * @return [A,C] after next(); next(); set(C)
	*/
	...
	/** Scenario: [A,B] -> previous(); set(C) -> [C,B]
	 * @return [C,B] after previous(); set(C)
	*/
	private IndexedUnsortedList<Integer> AB_ListIterSetCafterPrevious_CB() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		ListIterator<Integer> iter = list.listIterator(1);
	...
	/** Scenario: [A,B] -> previous(); set(C) -> [A,C]
	 * @return [A,C] after previous(); set(C)
	*/
	...
	/** Scenario: [A,B,C] -> next(); set(D) -> [D,B,C]
	 * @return [D,B,C] after next(); set(D)
	*/
	...
	/** Scenario: [A,B,C] -> next(); next(); set(D) -> [A,D,C]
	 * @return [A,D,C] after next(); next(); set(D)
	*/
	...
	/** Scenario: [A,B,C] -> next(); next(); next(); set(D) -> [A,B,D]
	 * @return [A,B,D] after next(); next(); next(); set(D)
	*/
	...
	/** Scenario: [A,B,C] -> previous(); set(D) -> [D,B,C]
	 * @return [D,B,C] after previous(); set(D)
	*/
	...
	/** Scenario: [A,B,C] -> previous(); set(D) -> [A,D,C]
	 * @return [A,D,C] after previous(); set(D)
	*/
	...
	/** Scenario: [A,B,C] -> previous(); set(D) -> [A,B,D]
	 * @return [A,B,D] after previous(); set(D)
	*/
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemove", testRemoveIndex(scenario.build(), 3, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemoveX", testRemoveElement(scenario.build(), ELEMENT_X, Result.NoSuchElement));
			printTest(scenarioName + "_testFirst", testFirst(scenario.build(), contents[0], Result.MatchingValue));
